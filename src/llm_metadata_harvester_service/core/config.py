...
CELERY_VISIBILITY_TIMEOUT_SECONDS = _get_int(
    "CELERY_VISIBILITY_TIMEOUT_SECONDS", 3900
)

JOB_MAX_EXECUTION_ATTEMPTS = _get_int("JOB_MAX_EXECUTION_ATTEMPTS", 3)
...
if not (
    ...
    raise ValueError(
        "Expected soft time limit < hard time limit < visibility timeout "
